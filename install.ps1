...
# Usage: irm https://raw.githubusercontent.com/<username>/<repo>/main/install.ps1 | iex
...
$scriptUrl = "https://raw.githubusercontent.com/FlorianBruniaux/claude-code-ultimate-guide/main/setup-claude-code-ultimate.ps1"
